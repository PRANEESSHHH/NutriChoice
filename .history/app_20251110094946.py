...
with col1:
    ...
    fig_protein.update_layout(
        title=dict(text=f'Top {top_n} High-Protein Foods', x=0.5, xanchor='center'),
...
with col2:
    ...
    fig_carbs.update_layout(
        title=dict(text=f'Top {top_n} High-Carb Foods', x=0.5, xanchor='center'),
...
with col1:
    ...
    fig_dist.update_layout(
        title=dict(text='Calorie Distribution', x=0.5, xanchor='center'),
...
with col2:
    ...
    fig_scatter.update_layout(
        title=dict(text='Protein vs Calories (Size: Fat, Color: Carbs)', x=0.5, xanchor='center'),
...
with col2:
    ...
    fig_pie.update_layout(
        title=dict(text='Macronutrient Distribution', x=0.5, xanchor='center'),
        height=400,
        plot_bgcolor='rgba(0,0,0,0)',
        paper_bgcolor='rgba(0,0,0,0)',
        font=dict(family='Inter', size=12),
