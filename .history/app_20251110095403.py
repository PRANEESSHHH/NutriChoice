...
<div style='text-align: center; padding: 2rem 0 1rem 0;'>
    <h1 style='font-size: 3rem; margin-bottom: 0.5rem;'>🥗 NutriVision</h1>
    <p style='font-size: 1.2rem; color: #636e72; margin: 0;'>Smart Nutrition Analysis & Diet Planning Dashboard</p>
</div>
""", unsafe_allow_html=True)
st.markdown("---")
...
# --- Top Foods Analysis ---
st.markdown("<h2 style='text-align: center; margin: 2rem 0 1rem 0;'>🏆 Top Nutritional Foods</h2>", unsafe_allow_html=True)
...
st.markdown("<h2 style='text-align: center; margin: 2rem 0 1rem 0;'>📊 Macronutrient Distribution & Analysis</h2>", unsafe_allow_html=True)
...
st.markdown("<h2 style='text-align: center; margin: 2rem 0 1rem 0;'>🥧 Average Macronutrient Composition</h2>", unsafe_allow_html=True)
...
# --- Detailed Statistics ---
if show_statistics:
    st.markdown("<h2 style='text-align: center; margin: 2rem 0 1rem 0;'>📈 Detailed Nutritional Statistics</h2>", unsafe_allow_html=True)
...
# --- Raw Data Table ---
if show_raw_data:
    st.markdown("<h2 style='text-align: center; margin: 2rem 0 1rem 0;'>📋 Complete Food Database</h2>", unsafe_allow_html=True)
    st.markdown(f"<p style='text-align: center; color: #636e72; margin-bottom: 1rem;'>*Showing {len(filtered_df)} of {len(df)} foods*</p>", unsafe_allow_html=True)
